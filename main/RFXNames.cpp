...
const char *RFX_Type_SubType_Desc(const unsigned char dType, const unsigned char sType)
{
	static const STR_TABLE_ID1_ID2	Table[] =
	{
		...
		{ pTypeGeneralSwitch, sSwitchIHCWiredRelay, "IHC Wired Relay" },
		{ pTypeGeneralSwitch, sSwitchIHCAirDimmer, "IHC Air Dimmer" },
		{ pTypeGeneralSwitch, sSwitchIHCWiredDimmer, "IHC Wired Dimmer" },
		{ pTypeGeneralSwitch, sSwitchIHCAirBtns, "IHC Air Buttons" },
		{ pTypeGeneralSwitch, sSwitchIHCWiredBtns, "IHC Wired Buttons" },
